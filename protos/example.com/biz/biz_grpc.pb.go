...
func (c *bizClient) GetUsers(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Result, error) {
	out := new(Result)
	err := c.cc.Invoke(ctx, "/biz/get_users", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bizClient) GetUsersWithSqlInject(ctx context.Context, in *RequestSqlInject, opts ...grpc.CallOption) (*Result, error) {
	out := new(Result)
	err := c.cc.Invoke(ctx, "/biz/get_users_with_sql_inject", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedBizServer) GetUsers(context.Context, *Request) (*Result, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetUsers not implemented")
}
func (UnimplementedBizServer) GetUsersWithSqlInject(context.Context, *RequestSqlInject) (*Result, error) {
...
func _Biz_GetUsers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/biz/get_users",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BizServer).GetUsers(ctx, req.(*Request))
	}
	return interceptor(ctx, in, info, handler)
}

func _Biz_GetUsersWithSqlInject_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RequestSqlInject)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BizServer).GetUsersWithSqlInject(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/biz/get_users_with_sql_inject",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BizServer).GetUsersWithSqlInject(ctx, req.(*RequestSqlInject))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Biz_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Biz_GetUsersWithSqlInject_Handler,
		},
	},
