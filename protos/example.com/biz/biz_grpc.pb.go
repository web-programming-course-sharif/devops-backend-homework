...
func (c *webClient) GetUsers(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Result, error) {
	out := new(Result)
	err := c.cc.Invoke(ctx, "/web/get_users", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *webClient) GetUsersWithSqlInject(ctx context.Context, in *RequestSqlInject, opts ...grpc.CallOption) (*Result, error) {
	out := new(Result)
	err := c.cc.Invoke(ctx, "/web/get_users_with_sql_inject", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Web_GetUsersWithSqlInject_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/web/get_users_with_sql_inject",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
